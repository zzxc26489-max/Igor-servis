...
export const partReferences: PartReference[] = [
  ...
  },
  {
    ...
    fitments: [
      ...
      "SEAT Leon III / IV",
      "Skoda Octavia III",
      "VW Golf VII / VIII / Golf Sportsvan",
    ],
    sourceName: "MANN-FILTER catalog",
    sourceUrl: "https://www.mann-filter.com/en/catalog/search-results/product.html/w712/95_mann-filter.html",
    note: "Применяемость зависит от двигателя и года выпуска; подтверждать по VIN.",
  },
  {
    id: "ref-mann-w719-45",
    name: "Фильтр масляный",
    ...
    sourceName: "MANN-FILTER catalog",
    sourceUrl: "https://www.mann-filter.com/en/catalog/search-results/product.html/w719/45_mann-filter.html",
    note: "Применяемость зависит от двигателя и года выпуска; подтверждать по VIN.",
  },
  {
    id: "ref-mann-c30005",
    ...
    fitments: [
      ...
      "VW Golf VII / Passat B8 / Tiguan II",
    ],
    sourceName: "MANN-FILTER catalog",
    sourceUrl: "https://www.mann-filter.com/en/catalog/search-results/product.html/c30005_mann-filter.html",
    note: "Применяемость зависит от двигателя и года выпуска; подтверждать по VIN.",
  },
  {
