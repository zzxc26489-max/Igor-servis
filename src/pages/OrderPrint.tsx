        ...
        >
          ...
          <section className="mt-5">
            ...
            <table className="client-order-table">
              <thead><tr><th>№</th><th>Наименование</th><th className="text-right">Кол-во</th><th className="text-right">Цена</th><th className="text-right">Сумма</th></tr></thead>
              <tbody>
          ...
          {order.parts.length > 0 && (
            <section className="mt-5">
              ...
              <table className="client-order-table">
                <thead><tr><th>№</th><th>Наименование</th><th>Артикул</th><th className="text-right">Кол-во</th><th className="text-right">Цена</th><th className="text-right">Сумма</th></tr></thead>
                <tbody>
