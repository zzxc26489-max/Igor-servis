    ...
    <>
      ...
      <Page>
        <article className="work-act mx-auto max-w-[900px] rounded-xl border bg-white p-5 shadow-sm sm:p-8 print:max-w-none print:border-0 print:p-0 print:shadow-none" style={{ borderColor: "var(--border)" }}>
          ...
          <section className="mt-7 text-sm leading-relaxed"><p>Работы выполнены в полном объёме. Заказчик осмотрел автомобиль и результат работ. Претензий к объёму, качеству и срокам выполнения работ не имеет.</p>{order.notes && <p className="mt-2"><b>Примечание:</b> {order.notes}</p>}</section>
